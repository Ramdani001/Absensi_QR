            ...
            <div class="col-lg-5 col-md-5 ht-lg-100p">
              <div class="card card-dashboard-one">
                ...
                <div class="card-body" style="margin-left: 20px; margin-right: 20px;">
                  <a href="index_masuk.php" class="btn btn-az-primary form-control">Absen</a>
                  <div class="ht-20"></div>
                  <!-- <a href="index_keluar.php" class="btn btn-az-primary form-control">Absensi Kepulangan</a> -->
                  <div class="ht-20"></div>
                    ...
                    <div class="card-body" style="margin-left: 20px; margin-right: 20px;">
                      <div class="table-responsive">
                        <table class="table table-striped mg-b-0">
                          ...
                          <tbody>
                            <?php
                            $query = mysqli_query($koneksi, "SELECT * FROM absensi LEFT JOIN person ON absensi.id_person = person.id_person ORDER BY id_absen DESC LIMIT 10");
                            $no = 1;
